var pauseState = {
  ...
  create: function() {
    ...
    var nameLabel = game.add.text(430, 50, 'PAUSE', { font: "bold 40px Orbitron", fill: "#fff"});
    nameLabel.anchor.x = 0.5;

    var restartLevel = game.add.text(430, 150, '[R] - To restart', { font: "20px Orbitron", fill: "#00e4ff"});
    restartLevel.anchor.x = 0.5;

    var backToMenuLabel = game.add.text(430, 180, '[M] - For menu', { font: "20px Orbitron", fill: "#00398e"});
